...
export default function RecentlyAssignedPanel({ onWriteDiagnosis }: RecentlyAssignedPanelProps) {
  ...
  if (loading) {
    return (
      <Card className="p-3 bg-linear-to-br from-emerald-500/5 to-green-500/5 border-emerald-200/20 animate-wave-ripple">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-7 h-7 rounded-lg bg-linear-to-br from-emerald-500/20 to-green-500/20 flex items-center justify-center">
    ...
    <Card className="p-3 bg-linear-to-br from-emerald-500/5 to-green-500/5 border-emerald-200/20 animate-wave-ripple">
      ...
      <div className="space-y-2 max-h-[400px] overflow-y-auto">
        {patients.map((patient) => (
          <div
            key={patient.id}
            className="p-2.5 rounded-lg bg-card border border-border hover:border-emerald-300/50 hover:shadow-sm transition-all group animate-wave-ripple"
          >
            <div className="flex items-start gap-2.5">
              <div className="w-9 h-9 rounded-lg bg-linear-to-br from-emerald-500/10 to-green-500/10 flex items-center justify-center font-semibold text-xs text-emerald-600 shrink-0 animate-heartbeat-lines">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Button
                  ...
                  className="w-full mt-2 h-7 text-xs bg-linear-to-r from-emerald-500 to-teal-400 hover:from-emerald-600 hover:to-teal-500 text-white shadow-sm animate-wave-pulse"
                >
