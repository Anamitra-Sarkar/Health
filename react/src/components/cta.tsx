    ...
    <section className="relative py-20 md:py-32 bg-gradient-to-br from-primary/8 via-accent/8 to-secondary/8 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-emerald-500/15 to-teal-400/15 border border-primary/30 mb-8 animate-glow-pulse">
            <div className="w-2 h-2 rounded-full bg-gradient-to-r from-emerald-400 to-teal-400 animate-heartbeat"></div>
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 text-balance">
            ...
            <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 via-green-400 to-teal-400">Clinical Workflows</span>
          </h2>
          
          <p className="text-lg lg:text-xl text-muted-foreground/90 mb-12 max-w-4xl mx-auto text-balance leading-relaxed">
            Join thousands of healthcare professionals using HealthSync EMR for secure, interoperable clinical workflows. Experience seamless patient care coordination today.
          </p>
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-8 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-emerald-400 animate-heartbeat"></div>
              <span>HIPAA Compliant</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-teal-400 animate-heartbeat" style={{animationDelay: '0.3s'}}></div>
              <span>FHIR Integration</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-green-400 animate-heartbeat" style={{animationDelay: '0.6s'}}></div>
